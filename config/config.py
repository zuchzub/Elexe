...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/zuchzub/Elexe")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/zuchzub/Elexe")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/ifurgl.jpg"
)
